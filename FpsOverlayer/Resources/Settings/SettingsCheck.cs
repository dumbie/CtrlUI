    ...
    public partial class WindowSettings
    {
        ...
        public void Settings_Check()
        {
            try
            {
                ...
                if (ConfigurationManager.AppSettings["DisplayOpacity"] == null) { SettingSave("DisplayOpacity", "0,85"); }
                ...
                if (ConfigurationManager.AppSettings["ColorSingle"] == null) { SettingSave("ColorSingle", "#FFFFFF"); }
                if (ConfigurationManager.AppSettings["ColorGpu"] == null) { SettingSave("ColorGpu", "#A3FF39"); }
                if (ConfigurationManager.AppSettings["ColorCpu"] == null) { SettingSave("ColorCpu", "#00E4FF"); }
                if (ConfigurationManager.AppSettings["ColorMem"] == null) { SettingSave("ColorMem", "#FFAA15"); }
                if (ConfigurationManager.AppSettings["ColorFps"] == null) { SettingSave("ColorFps", "#FF0505"); }
                if (ConfigurationManager.AppSettings["ColorNet"] == null) { SettingSave("ColorNet", "#F005FF"); }
                if (ConfigurationManager.AppSettings["ColorName"] == null) { SettingSave("ColorName", "#FFCD05"); }
