    ...
    partial class WindowMain
    {
        async Task FilePicker_FileCut_Clipboard(DataBindFile dataBindFile)
        {
            try
            {
                ...
                {
                    await Notification_Show_Status("Close", "Invalid file or folder");
        ...
        async Task FilePicker_FileCut_Single(DataBindFile dataBindFile)
        {
            try
            {
                await Notification_Show_Status("Cut", "Cutting file or folder");
        ...
        async Task FilePicker_FileCut_Checked()
        {
            try
            {
                await Notification_Show_Status("Cut", "Cutting files and folders");
