    ...
    partial class WindowMain
    {
        ...
        async Task ShowRecycleBinManager()
        {
            try
            {
                ...
                answerEmpty.ImageBitmap = FileToBitmapImage(new string[] { "Assets/Default/Icons/Remove.png" }, null, vImageBackupSource, IntPtr.Zero, -1, 0);
        ...
        void ListLoadAllRecycleBinFiles(List<DataBindString> targetList)
        {
            try
            {
                ...
                BitmapImage listImageFolder = FileToBitmapImage(new string[] { "Assets/Default/Icons/Folder.png" }, null, vImageBackupSource, IntPtr.Zero, -1, 0);
                BitmapImage listImageFile = FileToBitmapImage(new string[] { "Assets/Default/Icons/File.png" }, null, vImageBackupSource, IntPtr.Zero, -1, 0);
        ...
        async Task RecycleBin_RestoreDelete(FolderItem folderItem, Folder folder)
        {
            try
            {
                ...
                answerRestore.ImageBitmap = FileToBitmapImage(new string[] { "Assets/Default/Icons/Restart.png" }, null, vImageBackupSource, IntPtr.Zero, -1, 0);
                if (folderItem.IsFolder)
                {
                ...
                answerDelete.ImageBitmap = FileToBitmapImage(new string[] { "Assets/Default/Icons/Remove.png" }, null, vImageBackupSource, IntPtr.Zero, -1, 0);
                if (folderItem.IsFolder)
                {
