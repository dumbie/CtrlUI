...
namespace CtrlUI
{
    ...
    {
        //Get all the active Win32 and Win32Store processes and update the lists
            ...
            try
            {
                ...
                foreach (Process processApp in processesList)
                {
                    try
                    {
                        ...
                        string processNameExe = processMultiApp.ExecutableName;
                        ...
                        {
                            processMultiApp.WindowTitle = "File Explorer";
                        }
                        ...
                        BitmapImage processImageBitmap = FileToBitmapImage(new string[] { processMultiApp.WindowTitle, processNameExeNoExt, storeImageSquare, storeImageWide, processPathExeImage, processPathExe }, vImageSourceFolders, vImageBackupSource, processMultiApp.WindowHandle, vImageLoadSize, 0);
                    ...
                    {
                        Debug.WriteLine("Failed adding Win32 or Win32Store process: " + ex.Message);
                    }
                }
            }
            catch { }
