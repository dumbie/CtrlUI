    ...
    partial class WindowMain
    {
        ...
        async Task AmazonAddApplication(string appId, string appName, string appIcon, string installDir)
        {
            try
            {
                ...
                BitmapImage iconBitmapImage = FileToBitmapImage(new string[] { appName, appIcon, "Amazon" }, vImageSourceFolders, vImageBackupSource, IntPtr.Zero, vListBoxImageSize, 0);
