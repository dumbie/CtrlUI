    ...
    partial class WindowMain
    {
        ...
        async Task GooglePlayAddApplication(ShortcutDetails shortcutDetails)
        {
            try
            {
                ...
                {
                    FilePaths = [shortcutDetails.Title, shortcutDetails.IconPath, "Google Play"],
                ...
                DataBindApp dataBindApp = new DataBindApp()
                {
                    ...
                    StatusLauncherImage = await LoadLauncherImage(AppLauncher.GooglePlay, vImageLoadSizeApplication, 0)
                };
