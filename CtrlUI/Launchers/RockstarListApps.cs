    ...
    partial class WindowMain
    {
        ...
        async Task RockstarAddApplication(string appExe, string appName, string installDir)
        {
            try
            {
                ...
                BitmapImage iconBitmapImage = FileToBitmapImage(new string[] { appName, appExe, "Rockstar" }, vImageSourceFolders, vImageBackupSource, IntPtr.Zero, vListBoxImageSize, 0);
