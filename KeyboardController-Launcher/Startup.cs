    ...
    public partial class App : Application
    {
        ...
        protected override async void OnStartup(StartupEventArgs e)
        {
            try
            {
                ...
                await Application_LaunchCheck("Keyboard Controller Launcher", ProcessPriorityClass.Normal, false, false);
                ...
                Process launchProcess = await ProcessLauncherWin32Async("KeyboardController.exe", "", "", false, false);
                if (launchProcess == null)
                {
                    MessageBox.Show("Failed launching the application.", "Keyboard Controller Launcher");
                }
