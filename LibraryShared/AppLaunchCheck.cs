...
namespace LibraryShared
{
    public partial class AppStartupCheck
    {
        ...
        public static string[] ProfileFiles = { "Profiles/User/CtrlApplications.json", "Profiles/User/CtrlIgnoreProcessName.json", "Profiles/User/CtrlIgnoreLauncherName.json", "Profiles/User/CtrlIgnoreShortcutName.json", "Profiles/User/CtrlIgnoreShortcutUri.json", "Profiles/Default/CtrlCloseLaunchers.json", "Profiles/Default/DirectCloseTools.json", "Profiles/User/CtrlLocationsFile.json", "Profiles/User/CtrlLocationsShortcut.json", "Profiles/User/DirectControllersProfile.json", "Profiles/Default/DirectControllersSupported.json", "Profiles/User/DirectKeypadMapping.json", "Profiles/Default/DirectControllersIgnored.json", "Profiles/User/DirectControllersIgnored.json", "Profiles/User/FpsPositionProcessName.json", "Profiles/User/DirectKeyboardTextList.json", "Profiles/User/CtrlKeyboardExtensionName.json", "Profiles/User/CtrlKeyboardProcessName.json" };
