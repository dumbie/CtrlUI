    ...
    public partial class WindowKeyboard : Window
    {
        ...
        public void UpdateKeyboardKeysNormal()
        {
            try
            {
                ...
                key_Save.Tag = new KeyboardAction() { Modifiers = KeyboardModifiers.ControlLeft, Key0 = KeyboardKeys.S };
                key_Page.Content = "PgDn";
                key_Page.Tag = new KeyboardAction() { Key0 = KeyboardKeys.PageDown };
        ...
        public void UpdateKeyboardKeysCaps()
        {
            try
            {
                ...
                key_F7_Normal.Text = "±";
                key_F7_Caps.Text = "F7";
                key_F7.Tag = new KeyboardAction() { Modifiers = KeyboardModifiers.AltLeft, Key1 = KeyboardKeys.Numpad2, Key2 = KeyboardKeys.Numpad4, Key3 = KeyboardKeys.Numpad1 };
                key_F8_Normal.Text = "½";
                key_F8_Caps.Text = "F8";
                key_F8.Tag = new KeyboardAction() { Modifiers = KeyboardModifiers.AltLeft, Key0 = KeyboardKeys.Numpad0, Key1 = KeyboardKeys.Numpad1, Key2 = KeyboardKeys.Numpad8, Key3 = KeyboardKeys.Numpad9 };
                key_F9_Normal.Text = "¾";
                key_F9_Caps.Text = "F9";
                key_F9.Tag = new KeyboardAction() { Modifiers = KeyboardModifiers.AltLeft, Key0 = KeyboardKeys.Numpad0, Key1 = KeyboardKeys.Numpad1, Key2 = KeyboardKeys.Numpad9, Key3 = KeyboardKeys.Numpad0 };
                key_F10_Normal.Text = "©";
                key_F10_Caps.Text = "F10";
                key_F10.Tag = new KeyboardAction() { Modifiers = KeyboardModifiers.AltLeft, Key0 = KeyboardKeys.Numpad0, Key1 = KeyboardKeys.Numpad1, Key2 = KeyboardKeys.Numpad6, Key3 = KeyboardKeys.Numpad9 };
                key_F11_Normal.Text = "™";
                key_F11_Caps.Text = "F11";
                key_F11.Tag = new KeyboardAction() { Modifiers = KeyboardModifiers.AltLeft, Key0 = KeyboardKeys.Numpad0, Key1 = KeyboardKeys.Numpad1, Key2 = KeyboardKeys.Numpad5, Key3 = KeyboardKeys.Numpad3 };
                key_F12_Normal.Text = "¿";
                key_F12_Caps.Text = "F12";
                key_F12.Tag = new KeyboardAction() { Modifiers = KeyboardModifiers.AltLeft, Key0 = KeyboardKeys.Numpad0, Key1 = KeyboardKeys.Numpad1, Key2 = KeyboardKeys.Numpad9, Key3 = KeyboardKeys.Numpad1 };
                ...
                key_Save.Tag = new KeyboardAction() { Modifiers = KeyboardModifiers.ControlLeft, Key0 = KeyboardKeys.F };
                key_Page.Content = "PgUp";
                key_Page.Tag = new KeyboardAction() { Key0 = KeyboardKeys.PageUp };
