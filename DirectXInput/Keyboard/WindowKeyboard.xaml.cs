        ...
        void UpdateWindowStyle()
        {
            try
            {
                AVActions.ActionDispatcherInvoke(delegate
                {
                    ...
                    SetWindowPos(vInteropWindowHandle, (IntPtr)WindowPosition.TopMost, 0, 0, 0, 0, (int)(WindowSWP.NOMOVE | WindowSWP.NOSIZE | WindowSWP.FRAMECHANGED | WindowSWP.NOCOPYBITS | WindowSWP.NOCOPYBITS));
                });
            }
            catch { }
        }
