    ...
    public partial class WindowKeyboard : Window
    {
        ...
        public void UpdateKeyboardKeysNormal()
        {
            try
            {
                ...
                key_Delete.Tag = new KeyboardAction() { Key0 = KeyboardKeys.Delete };
                key_End.Content = "End";
                ...
                key_Shift.Tag = new KeyboardAction() { Modifier0 = KeyboardModifiers.ShiftLeft };
                key_z.Content = "z";
                ...
                key_Control.Tag = new KeyboardAction() { Modifier0 = KeyboardModifiers.ControlLeft };
                key_Alt.Content = "Alt";
                key_Alt.Tag = new KeyboardAction() { Modifier0 = KeyboardModifiers.AltLeft };
                key_LeftWindows.Content = "Windows";
                key_LeftWindows.Tag = new KeyboardAction() { Modifier0 = KeyboardModifiers.WindowsLeft };
        ...
        public void UpdateKeyboardKeysCaps()
        {
            try
            {
                ...
                key_F1_Normal.Text = "€";
                key_F1_Caps.Text = "F1";
                key_F1.Tag = new KeyboardAction() { Modifier0 = KeyboardModifiers.AltLeft, Key0 = KeyboardKeys.Numpad0, Key1 = KeyboardKeys.Numpad1, Key2 = KeyboardKeys.Numpad2, Key3 = KeyboardKeys.Numpad8 };
                key_F2_Normal.Text = "£";
                key_F2_Caps.Text = "F2";
                key_F2.Tag = new KeyboardAction() { Modifier0 = KeyboardModifiers.AltLeft, Key0 = KeyboardKeys.Numpad0, Key1 = KeyboardKeys.Numpad1, Key2 = KeyboardKeys.Numpad6, Key3 = KeyboardKeys.Numpad3 };
                key_F3_Normal.Text = "¥";
                key_F3_Caps.Text = "F3";
                key_F3.Tag = new KeyboardAction() { Modifier0 = KeyboardModifiers.AltLeft, Key0 = KeyboardKeys.Numpad0, Key1 = KeyboardKeys.Numpad1, Key2 = KeyboardKeys.Numpad6, Key3 = KeyboardKeys.Numpad5 };
                key_F4_Normal.Text = "¢";
                key_F4_Caps.Text = "F4";
                key_F4.Tag = new KeyboardAction() { Modifier0 = KeyboardModifiers.AltLeft, Key0 = KeyboardKeys.Numpad0, Key1 = KeyboardKeys.Numpad1, Key2 = KeyboardKeys.Numpad6, Key3 = KeyboardKeys.Numpad2 };
                key_F5_Normal.Text = "¤";
                key_F5_Caps.Text = "F5";
                key_F5.Tag = new KeyboardAction() { Modifier0 = KeyboardModifiers.AltLeft, Key0 = KeyboardKeys.Numpad0, Key1 = KeyboardKeys.Numpad1, Key2 = KeyboardKeys.Numpad6, Key3 = KeyboardKeys.Numpad4 };
                key_F6_Normal.Text = "°";
                key_F6_Caps.Text = "F6";
                key_F6.Tag = new KeyboardAction() { Modifier0 = KeyboardModifiers.AltLeft, Key0 = KeyboardKeys.Numpad0, Key1 = KeyboardKeys.Numpad1, Key2 = KeyboardKeys.Numpad7, Key3 = KeyboardKeys.Numpad6 };
                key_F7_Normal.Text = "÷";
                key_F7_Caps.Text = "F7";
                key_F7.Tag = new KeyboardAction() { Modifier0 = KeyboardModifiers.AltLeft, Key0 = KeyboardKeys.Numpad0, Key1 = KeyboardKeys.Numpad2, Key2 = KeyboardKeys.Numpad4, Key3 = KeyboardKeys.Numpad7 };
                key_F8_Normal.Text = "±";
                key_F8_Caps.Text = "F8";
                key_F8.Tag = new KeyboardAction() { Modifier0 = KeyboardModifiers.AltLeft, Key0 = KeyboardKeys.Numpad2, Key1 = KeyboardKeys.Numpad4, Key2 = KeyboardKeys.Numpad1 };
                key_F9_Normal.Text = "½";
                key_F9_Caps.Text = "F9";
                key_F9.Tag = new KeyboardAction() { Modifier0 = KeyboardModifiers.AltLeft, Key0 = KeyboardKeys.Numpad0, Key1 = KeyboardKeys.Numpad1, Key2 = KeyboardKeys.Numpad8, Key3 = KeyboardKeys.Numpad9 };
                key_F10_Normal.Text = "©";
                key_F10_Caps.Text = "F10";
                key_F10.Tag = new KeyboardAction() { Modifier0 = KeyboardModifiers.AltLeft, Key0 = KeyboardKeys.Numpad0, Key1 = KeyboardKeys.Numpad1, Key2 = KeyboardKeys.Numpad6, Key3 = KeyboardKeys.Numpad9 };
                key_F11_Normal.Text = "™";
                key_F11_Caps.Text = "F11";
                key_F11.Tag = new KeyboardAction() { Modifier0 = KeyboardModifiers.AltLeft, Key0 = KeyboardKeys.Numpad0, Key1 = KeyboardKeys.Numpad1, Key2 = KeyboardKeys.Numpad5, Key3 = KeyboardKeys.Numpad3 };
                key_F12_Normal.Text = "¿";
                key_F12_Caps.Text = "F12";
                key_F12.Tag = new KeyboardAction() { Modifier0 = KeyboardModifiers.AltLeft, Key0 = KeyboardKeys.Numpad0, Key1 = KeyboardKeys.Numpad1, Key2 = KeyboardKeys.Numpad9, Key3 = KeyboardKeys.Numpad1 };
                key_Delete.Content = "Insert";
                key_Delete.Tag = new KeyboardAction() { Key0 = KeyboardKeys.Insert };
                ...
                key_Tilde_Normal.Text = "~";
                key_Tilde_Caps.Text = "`";
                key_Tilde.Tag = new KeyboardAction() { Modifier0 = KeyboardModifiers.ShiftLeft, Key0 = KeyboardKeys.Backtick };
                key_1_Normal.Text = "!";
                key_1_Caps.Text = "1";
                key_1.Tag = new KeyboardAction() { Modifier0 = KeyboardModifiers.ShiftLeft, Key0 = KeyboardKeys.Digit1 };
                key_2_Normal.Text = "@";
                key_2_Caps.Text = "2";
                key_2.Tag = new KeyboardAction() { Modifier0 = KeyboardModifiers.ShiftLeft, Key0 = KeyboardKeys.Digit2 };
                key_3_Normal.Text = "#";
                key_3_Caps.Text = "3";
                key_3.Tag = new KeyboardAction() { Modifier0 = KeyboardModifiers.ShiftLeft, Key0 = KeyboardKeys.Digit3 };
                key_4_Normal.Text = "$";
                key_4_Caps.Text = "4";
                key_4.Tag = new KeyboardAction() { Modifier0 = KeyboardModifiers.ShiftLeft, Key0 = KeyboardKeys.Digit4 };
                key_5_Normal.Text = "%";
                key_5_Caps.Text = "5";
                key_5.Tag = new KeyboardAction() { Modifier0 = KeyboardModifiers.ShiftLeft, Key0 = KeyboardKeys.Digit5 };
                key_6_Normal.Text = "^";
                key_6_Caps.Text = "6";
                key_6.Tag = new KeyboardAction() { Modifier0 = KeyboardModifiers.ShiftLeft, Key0 = KeyboardKeys.Digit6 };
                key_7_Normal.Text = "&";
                key_7_Caps.Text = "7";
                key_7.Tag = new KeyboardAction() { Modifier0 = KeyboardModifiers.ShiftLeft, Key0 = KeyboardKeys.Digit7 };
                key_8_Normal.Text = "*";
                key_8_Caps.Text = "8";
                key_8.Tag = new KeyboardAction() { Modifier0 = KeyboardModifiers.ShiftLeft, Key0 = KeyboardKeys.Digit8 };
                key_9_Normal.Text = "(";
                key_9_Caps.Text = "9";
                key_9.Tag = new KeyboardAction() { Modifier0 = KeyboardModifiers.ShiftLeft, Key0 = KeyboardKeys.Digit9 };
                key_0_Normal.Text = ")";
                key_0_Caps.Text = "0";
                key_0.Tag = new KeyboardAction() { Modifier0 = KeyboardModifiers.ShiftLeft, Key0 = KeyboardKeys.Digit0 };
                key_Minus_Normal.Text = "_";
                key_Minus_Caps.Text = "-";
                key_Minus.Tag = new KeyboardAction() { Modifier0 = KeyboardModifiers.ShiftLeft, Key0 = KeyboardKeys.Minus };
                key_Plus_Normal.Text = "+";
                key_Plus_Caps.Text = "=";
                key_Plus.Tag = new KeyboardAction() { Modifier0 = KeyboardModifiers.ShiftLeft, Key0 = KeyboardKeys.Equal };
                key_BackSpace.Content = "Backspace";
                key_BackSpace.Tag = new KeyboardAction() { Key0 = KeyboardKeys.Backspace };

                //Key Row 2
                key_Tab.Content = "<Tab";
                key_Tab.Tag = new KeyboardAction() { Modifier0 = KeyboardModifiers.ShiftLeft, Key0 = KeyboardKeys.Tab };
                key_q.Content = "Q";
                key_q.Tag = new KeyboardAction() { Modifier0 = KeyboardModifiers.ShiftLeft, Key0 = KeyboardKeys.Q };
                key_w.Content = "W";
                key_w.Tag = new KeyboardAction() { Modifier0 = KeyboardModifiers.ShiftLeft, Key0 = KeyboardKeys.W };
                key_e.Content = "E";
                key_e.Tag = new KeyboardAction() { Modifier0 = KeyboardModifiers.ShiftLeft, Key0 = KeyboardKeys.E };
                key_r.Content = "R";
                key_r.Tag = new KeyboardAction() { Modifier0 = KeyboardModifiers.ShiftLeft, Key0 = KeyboardKeys.R };
                key_t.Content = "T";
                key_t.Tag = new KeyboardAction() { Modifier0 = KeyboardModifiers.ShiftLeft, Key0 = KeyboardKeys.T };
                key_y.Content = "Y";
                key_y.Tag = new KeyboardAction() { Modifier0 = KeyboardModifiers.ShiftLeft, Key0 = KeyboardKeys.Y };
                key_u.Content = "U";
                key_u.Tag = new KeyboardAction() { Modifier0 = KeyboardModifiers.ShiftLeft, Key0 = KeyboardKeys.U };
                key_i.Content = "I";
                key_i.Tag = new KeyboardAction() { Modifier0 = KeyboardModifiers.ShiftLeft, Key0 = KeyboardKeys.I };
                key_o.Content = "O";
                key_o.Tag = new KeyboardAction() { Modifier0 = KeyboardModifiers.ShiftLeft, Key0 = KeyboardKeys.O };
                key_p.Content = "P";
                key_p.Tag = new KeyboardAction() { Modifier0 = KeyboardModifiers.ShiftLeft, Key0 = KeyboardKeys.P };
                key_OpenBracket_Normal.Text = "{";
                key_OpenBracket_Caps.Text = "[";
                key_OpenBracket.Tag = new KeyboardAction() { Modifier0 = KeyboardModifiers.ShiftLeft, Key0 = KeyboardKeys.LeftBracket };
                key_CloseBracket_Normal.Text = "}";
                key_CloseBracket_Caps.Text = "]";
                key_CloseBracket.Tag = new KeyboardAction() { Modifier0 = KeyboardModifiers.ShiftLeft, Key0 = KeyboardKeys.RightBracket };

                //Key Row 3
                key_CapsLock.Content = "CAPS";
                key_CapsLock.Tag = new KeyboardAction() { Key0 = KeyboardKeys.CapsLock };
                key_a.Content = "A";
                key_a.Tag = new KeyboardAction() { Modifier0 = KeyboardModifiers.ShiftLeft, Key0 = KeyboardKeys.A };
                key_s.Content = "S";
                key_s.Tag = new KeyboardAction() { Modifier0 = KeyboardModifiers.ShiftLeft, Key0 = KeyboardKeys.S };
                key_d.Content = "D";
                key_d.Tag = new KeyboardAction() { Modifier0 = KeyboardModifiers.ShiftLeft, Key0 = KeyboardKeys.D };
                key_f.Content = "F";
                key_f.Tag = new KeyboardAction() { Modifier0 = KeyboardModifiers.ShiftLeft, Key0 = KeyboardKeys.F };
                key_g.Content = "G";
                key_g.Tag = new KeyboardAction() { Modifier0 = KeyboardModifiers.ShiftLeft, Key0 = KeyboardKeys.G };
                key_h.Content = "H";
                key_h.Tag = new KeyboardAction() { Modifier0 = KeyboardModifiers.ShiftLeft, Key0 = KeyboardKeys.H };
                key_j.Content = "J";
                key_j.Tag = new KeyboardAction() { Modifier0 = KeyboardModifiers.ShiftLeft, Key0 = KeyboardKeys.J };
                key_k.Content = "K";
                key_k.Tag = new KeyboardAction() { Modifier0 = KeyboardModifiers.ShiftLeft, Key0 = KeyboardKeys.K };
                key_l.Content = "L";
                key_l.Tag = new KeyboardAction() { Modifier0 = KeyboardModifiers.ShiftLeft, Key0 = KeyboardKeys.L };
                key_Semicolon_Normal.Text = ":";
                key_Semicolon_Caps.Text = ";";
                key_Semicolon.Tag = new KeyboardAction() { Modifier0 = KeyboardModifiers.ShiftLeft, Key0 = KeyboardKeys.Semicolon };
                key_Quote_Normal.Text = "\"";
                key_Quote_Caps.Text = "'";
                ...
                key_Shift.Tag = new KeyboardAction() { Modifier0 = KeyboardModifiers.ControlLeft, Key0 = KeyboardKeys.X };
                key_z.Content = "Z";
                key_z.Tag = new KeyboardAction() { Modifier0 = KeyboardModifiers.ShiftLeft, Key0 = KeyboardKeys.Z };
                key_x.Content = "X";
                key_x.Tag = new KeyboardAction() { Modifier0 = KeyboardModifiers.ShiftLeft, Key0 = KeyboardKeys.X };
                key_c.Content = "C";
                key_c.Tag = new KeyboardAction() { Modifier0 = KeyboardModifiers.ShiftLeft, Key0 = KeyboardKeys.C };
                key_v.Content = "V";
                key_v.Tag = new KeyboardAction() { Modifier0 = KeyboardModifiers.ShiftLeft, Key0 = KeyboardKeys.V };
                key_b.Content = "B";
                key_b.Tag = new KeyboardAction() { Modifier0 = KeyboardModifiers.ShiftLeft, Key0 = KeyboardKeys.B };
                key_n.Content = "N";
                key_n.Tag = new KeyboardAction() { Modifier0 = KeyboardModifiers.ShiftLeft, Key0 = KeyboardKeys.N };
                key_m.Content = "M";
                key_m.Tag = new KeyboardAction() { Modifier0 = KeyboardModifiers.ShiftLeft, Key0 = KeyboardKeys.M };
                key_Comma_Normal.Text = "<";
                key_Comma_Caps.Text = ",";
                key_Comma.Tag = new KeyboardAction() { Modifier0 = KeyboardModifiers.ShiftLeft, Key0 = KeyboardKeys.Comma };
                key_Period_Normal.Text = ">";
                key_Period_Caps.Text = ".";
                key_Period.Tag = new KeyboardAction() { Modifier0 = KeyboardModifiers.ShiftLeft, Key0 = KeyboardKeys.Period };
                key_Question_Normal.Text = "?";
                key_Question_Caps.Text = "/";
                ...
                key_Control.Tag = new KeyboardAction() { Modifier0 = KeyboardModifiers.ControlLeft, Key0 = KeyboardKeys.C };
                key_Alt.Content = "Paste";
                key_Alt.Tag = new KeyboardAction() { Modifier0 = KeyboardModifiers.ControlLeft, Key0 = KeyboardKeys.V };
                key_LeftWindows.Content = "Select all";
                key_LeftWindows.Tag = new KeyboardAction() { Modifier0 = KeyboardModifiers.ControlLeft, Key0 = KeyboardKeys.A };
                key_Space.Content = "Space";
                key_Space.Tag = new KeyboardAction() { Key0 = KeyboardKeys.Space };
                key_Enter.Content = "Undo";
                key_Enter.Tag = new KeyboardAction() { Modifier0 = KeyboardModifiers.ControlLeft, Key0 = KeyboardKeys.Z };
