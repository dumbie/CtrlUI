                ...
                while (Controller.InputTask != null && Controller.HidDevice != null)
                {
                    try
                    {
                        ...
                        else
                        {
                            ...
                            if (Controller.Details.Profile.ButtonA == null) { Controller.InputCurrent.ButtonA = Controller.InputCurrent.RawBytes[1]; } else { Controller.InputCurrent.ButtonA = Controller.InputCurrent.RawBytes[Controller.Details.Profile.ButtonA.Value]; }
                            if (Controller.Details.Profile.ButtonB == null) { Controller.InputCurrent.ButtonB = Controller.InputCurrent.RawBytes[2]; } else { Controller.InputCurrent.ButtonB = Controller.InputCurrent.RawBytes[Controller.Details.Profile.ButtonB.Value]; }
                            if (Controller.Details.Profile.ButtonX == null) { Controller.InputCurrent.ButtonX = Controller.InputCurrent.RawBytes[0]; } else { Controller.InputCurrent.ButtonX = Controller.InputCurrent.RawBytes[Controller.Details.Profile.ButtonX.Value]; }
                            if (Controller.Details.Profile.ButtonY == null) { Controller.InputCurrent.ButtonY = Controller.InputCurrent.RawBytes[3]; } else { Controller.InputCurrent.ButtonY = Controller.InputCurrent.RawBytes[Controller.Details.Profile.ButtonY.Value]; }
                            if (Controller.Details.Profile.ButtonBack == null) { Controller.InputCurrent.ButtonBack = Controller.InputCurrent.RawBytes[24]; } else { Controller.InputCurrent.ButtonBack = Controller.InputCurrent.RawBytes[Controller.Details.Profile.ButtonBack.Value]; }
                            if (Controller.Details.Profile.ButtonStart == null) { Controller.InputCurrent.ButtonStart = Controller.InputCurrent.RawBytes[25]; } else { Controller.InputCurrent.ButtonStart = Controller.InputCurrent.RawBytes[Controller.Details.Profile.ButtonStart.Value]; }
                            ...
                            if (Controller.Details.Profile.ButtonTriggerLeft == null) { Controller.InputCurrent.ButtonTriggerLeft = Controller.InputCurrent.RawBytes[22]; } else { Controller.InputCurrent.ButtonTriggerLeft = Controller.InputCurrent.RawBytes[Controller.Details.Profile.ButtonTriggerLeft.Value]; }
                            if (Controller.Details.Profile.ButtonTriggerRight == null) { Controller.InputCurrent.ButtonTriggerRight = Controller.InputCurrent.RawBytes[23]; } else { Controller.InputCurrent.ButtonTriggerRight = Controller.InputCurrent.RawBytes[Controller.Details.Profile.ButtonTriggerRight.Value]; }
                            if (Controller.Details.Profile.ButtonShoulderLeft == null) { Controller.InputCurrent.ButtonShoulderLeft = Controller.InputCurrent.RawBytes[20]; } else { Controller.InputCurrent.ButtonShoulderLeft = Controller.InputCurrent.RawBytes[Controller.Details.Profile.ButtonShoulderLeft.Value]; }
                            if (Controller.Details.Profile.ButtonShoulderRight == null) { Controller.InputCurrent.ButtonShoulderRight = Controller.InputCurrent.RawBytes[21]; } else { Controller.InputCurrent.ButtonShoulderRight = Controller.InputCurrent.RawBytes[Controller.Details.Profile.ButtonShoulderRight.Value]; }
                            if (Controller.Details.Profile.ButtonThumbLeft == null) { Controller.InputCurrent.ButtonThumbLeft = Controller.InputCurrent.RawBytes[26]; } else { Controller.InputCurrent.ButtonThumbLeft = Controller.InputCurrent.RawBytes[Controller.Details.Profile.ButtonThumbLeft.Value]; }
                            if (Controller.Details.Profile.ButtonThumbRight == null) { Controller.InputCurrent.ButtonThumbRight = Controller.InputCurrent.RawBytes[27]; } else { Controller.InputCurrent.ButtonThumbRight = Controller.InputCurrent.RawBytes[Controller.Details.Profile.ButtonThumbRight.Value]; }
