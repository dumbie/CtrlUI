            ...
            try
            {
                ...
                if (Controller.Connected())
                {
                    ...
                    AVActions.ActionDispatcherInvoke(delegate
                    {
                        ...
                        {
                            image_Controller0.Source = FileToBitmapImage(new string[] { "Assets/Icons/Controller-Dark.png" }, IntPtr.Zero, -1, 0);
                            textblock_Controller0.Text = "No controller connected";
                        }
                        else if (Controller.NumberId == 1)
                        {
                            image_Controller1.Source = FileToBitmapImage(new string[] { "Assets/Icons/Controller-Dark.png" }, IntPtr.Zero, -1, 0);
                            textblock_Controller1.Text = "No controller connected";
                        }
                        else if (Controller.NumberId == 2)
                        {
                            image_Controller2.Source = FileToBitmapImage(new string[] { "Assets/Icons/Controller-Dark.png" }, IntPtr.Zero, -1, 0);
                            textblock_Controller2.Text = "No controller connected";
                        }
                        else if (Controller.NumberId == 3)
                        {
                            image_Controller3.Source = FileToBitmapImage(new string[] { "Assets/Icons/Controller-Dark.png" }, IntPtr.Zero, -1, 0);
